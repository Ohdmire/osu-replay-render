...
impl HudState {
    ...
    /// the key letter (Exo 2 Bold 15, `OsuColour.Blue0`), the cumulative
    /// press count (Exo 2 Bold 21) and a top indicator line (4.5 tall, alpha
    ...
    fn draw_key_overlay(&mut self, game: &GameData, assets: &Assets, list: &mut DrawList, m: &Mapper, t: f64) {
        ...
        for k in 0..3 {
            ...
            // at Exo 2 21) above it — the same line the combo digits end on.
