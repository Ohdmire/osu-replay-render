...
const EXO2_SEMI_BOLD_TTF: &[u8] = include_bytes!("../assets/fonts/Exo 2Pro-SemiBold.ttf");
...
pub fn build_atlas(
    ...
    let (mut semibold, mut semibold_images) = TtfFont::rasterize(EXO2_SEMI_BOLD_TTF, false);
